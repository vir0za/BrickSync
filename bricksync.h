...
#define BS_BRICKLINK_ACCOUNT_SERVER "account.prod.member.bricklink.info"
#define BS_BRICKLINK_TPA_CLIENT_ID "ca629c09-4d8c-45dc-8a6f-bfb2b058f720"
...
typedef struct
{
  ...
  char *webaddress;
  char *accountaddress;
  /* BrickStore access-token based auth (optional) */
  char *brickstoretoken;
  char *sessiontoken;
  /* API HTTP connection */
  httpConnection *http;
  /* Web HTTP connection */
  httpConnection *webhttp;
  /* Web HTTPS connection (for BrickStore-style authenticated web calls) */
  httpConnection *webhttpshttp;
  /* Account HTTPS connection (verify-and-create-session) */
  httpConnection *accounthttp;
